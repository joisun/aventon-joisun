          ...
          <div class="mb-2 w-full flex items-center gap-4">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm flex flex-col sm:flex-row">
                ...
                <span class="hidden sm:inline text-foreground-secondary/50 mx-2">/</span>
                <span class="text-xs sm:text-sm text-foreground-secondary">Registered on {{ user.date && formatDateToLocal(user.date) }}</span>
              </p>
              <!-- prettier-ignore-end -->
            </div>
          </div>
        </div>
        <div class="flex flex-col w-full items-start justify-between pt-4 gap-1">
          <p>
